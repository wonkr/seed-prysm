...
var (
	...
	generateGenesisStateCmd = &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				Name:        "config-name",
				Usage:       "Config kind to be used for generating the genesis state. Default: mainnet. Options include mainnet, interop, minimal, prater, ropsten, sepolia, seed. --chain-config-file will override this flag.",
